...
class SoundManager:
    def __init__(self):
        ...
        # Load sound effects
        self.shotgun = pygame.mixer.Sound(sound("shotgun_sfx.mp3"))
        self.shotgun_blank = pygame.mixer.Sound(sound("shotgun_blank_sfx.mp3"))
        self.street_ambience = pygame.mixer.Sound(sound("street_ambience_sfx.mp3"))
        self.walking = pygame.mixer.Sound(sound("walking_sfx.mp3"))
        ...
        # Music file paths
        self._music = {"start_menu": sound("start_menu_music.mp3"), "end_menu":   sound("end_menu_music.mp3")}
