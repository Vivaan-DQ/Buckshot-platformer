...
#CHECKLIST SCENE 3 
# - AS SOON AS PLAYER DIES, CUT ALL ANIIMATIONS SOUND MUSIC ETC. MAKE THE BLACK CREEN COME ON AS FAST AS POSSIBLE
# and add a high pitched ringing.
#MAYBE PUT IN DOORS RUSH ANIMATION DEATH ONCE PLAYER DIES.


#CHECKLIST GENERAL

# - REVISIT UML TO CHECK FOR ANY DIFFERENCES
